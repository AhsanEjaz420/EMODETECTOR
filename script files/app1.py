...
def record_audio():
    ...
    while st.session_state.audio_running:
        # Record audio
...
# Create buttons to start/stop video and audio capture
if st.button('Start Video Detection'):
    st.session_state.video_running = True
    capture_video()

if st.button('Stop Video Detection'):
    st.session_state.video_running = False

if st.button('Start Audio Detection'):
    st.session_state.audio_running = True
    record_audio()

if st.button('Stop Audio Detection'):
    st.session_state.audio_running = False
